...
func main() {
    ...
    mux.HandleFunc("/metadata", rateLimitMiddleware(apiKeyMiddleware(handleMetadata)))
    ...
    mux.HandleFunc("/convert-audio", rateLimitMiddleware(apiKeyMiddleware(handleConvertAudio)))
